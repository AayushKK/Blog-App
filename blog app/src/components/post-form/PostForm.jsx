...
import {Button, MyInput, MySelect,RealtimeEditor } from "../index"
import { useNavigate } from "react-router-dom";
import { useDispatch, useSelector } from "react-redux";
import { addPost, updatePost } from "../../slices/postsSlice";
    ...
    <div className="w-1/3 px-2">
        ...
        {post && (
            <div className="w-full mb-4">
                <img
                    src={blogService.getImagePreview(post.featuredImage)}
                    alt={post.title}
